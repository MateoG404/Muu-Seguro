...
public class InterfazPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldAuxContraseñaInicio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldAuxContraseñaInicioActionPerformed(evt);
            }
        });
        ...
        getContentPane().add(jPanelIniciarSesión, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, 400, 500));
        ...
        jCheckBoxMuuAmbas.setSelected(true);
        ...
        jCheckBoxMuuLeche.setSelected(true);
        ...
        jTextFieldAuxContraseñaReg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldAuxContraseñaRegActionPerformed(evt);
            }
        });
        ...
        getContentPane().add(jPanelRegistro, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 40, 400, 500));

        jLabelImageFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interfaz/DataImage/fondoMuu.png"))); // NOI18N
        getContentPane().add(jLabelImageFondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1000, 570));
...
*/
    ...
    private void jTextFieldAuxContraseñaInicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldAuxContraseñaInicioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldAuxContraseñaInicioActionPerformed
    /*
    ...
    */
    ...
    private void jTextFieldAuxContraseñaRegActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldAuxContraseñaRegActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldAuxContraseñaRegActionPerformed
    ...
    */
    private void jTextFieldInicioCodigoEmpKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldInicioCodigoEmpKeyTyped
        if(ingresoComas(jTextFieldInicioCodigoEmp, evt.getKeyChar())){ 
    ...
    private void jTextFieldNombreUsuarioInicioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldNombreUsuarioInicioKeyTyped
        if(ingresoComas(jTextFieldNombreUsuarioInicio, evt.getKeyChar())){ 
           JOptionPane.showMessageDialog(null, "No se permite el ingreso de este caracter", "Advertencia", JOptionPane.WARNING_MESSAGE);
           evt.consume();
        }
    ...
    private void jPasswordFieldInicioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPasswordFieldInicioKeyTyped
        if(ingresoComasPass(jPasswordFieldInicio, evt.getKeyChar())){ 
           JOptionPane.showMessageDialog(null, "No se permite el ingreso de este caracter", "Advertencia", JOptionPane.WARNING_MESSAGE);
           evt.consume();
        }
    ...
    private void jTextFieldRegistroCorreoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldRegistroCorreoKeyTyped
        if(ingresoComas(jTextFieldRegistroCorreo, evt.getKeyChar())){ 
           JOptionPane.showMessageDialog(null, "No se permite el ingreso de este caracter", "Advertencia", JOptionPane.WARNING_MESSAGE);
           evt.consume();
        }
    ...
    private void jTextFieldRegistroUsuarioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldRegistroUsuarioKeyTyped
        if(ingresoComas(jTextFieldRegistroUsuario, evt.getKeyChar())){ 
           JOptionPane.showMessageDialog(null, "No se permite el ingreso de este caracter", "Advertencia", JOptionPane.WARNING_MESSAGE);
           evt.consume();
        }
    ...
    private void jPasswordFieldRegistroKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPasswordFieldRegistroKeyTyped
        if(ingresoComasPass(jPasswordFieldRegistro, evt.getKeyChar())){ 
           JOptionPane.showMessageDialog(null, "No se permite el ingreso de este caracter", "Advertencia", JOptionPane.WARNING_MESSAGE);
           evt.consume();
        }
    ...
    *usuarios perteneciantes a una cierta empresa 
    */
    private String pathUsers;
    /*
    Iniciar componentes de otras librerías
    */
    //METODOS PROPIOS
    ...
    */
    private String comprobarSelecciondeCheckBox(){
        if((jCheckBoxMuuAmbas.isSelected() && jCheckBoxMuuLeche.isSelected() && jCheckBoxMuuCarne.isSelected())
            || (jCheckBoxMuuAmbas.isSelected() && jCheckBoxMuuLeche.isSelected())
            || (jCheckBoxMuuAmbas.isSelected() && jCheckBoxMuuCarne.isSelected())
            || (jCheckBoxMuuCarne.isSelected() && jCheckBoxMuuLeche.isSelected())    
            || (!jCheckBoxMuuAmbas.isSelected()&& !jCheckBoxMuuLeche.isSelected() && !jCheckBoxMuuCarne.isSelected())
        ){
            jCheckBoxMuuLeche.setSelected(false);
            jCheckBoxMuuCarne.setSelected(false);
            jCheckBoxMuuAmbas.setSelected(true);
            return "Doble";
        }else{
    ...
    */
                ...
                try{
                    ...
                    while((linea=br.readLine())!= null){//cada linea del archivo csv
                        ...
                        if(valores[0].equals(codigoEmp) && valores[3].equals(nombreUsuario) && valores[4].equals(contraseña)){
                             System.out.println(valores[0]+valores[3]+valores[4]);
                            return true;
                        }   
                    }
                }catch(Exception ex){
    ...
    private void desaparecerPaneles(){
        jPanelIniciarSesión.setVisible(false);
        jPanelRegistro.setVisible(false);
        jTextFieldRegistroCorreo.setText("");
        jTextFieldRegistroUsuario.setText("");
    ...
    */
    private boolean ingresoComas(javax.swing.JTextField auxiliar, char caracter){
        if(caracter==','){    
            return true;
        }
        return false;
    ...
    /*
    *Ingreso de comas en jPassword
    */
    private boolean ingresoComasPass(javax.swing.JPasswordField auxiliar, char caracter){
        if(caracter==','){    
            return true;
        }
        return false;
